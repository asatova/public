...
class Dashboard extends Controller {
	...
	public function save_settings() {
		...
		$settings->sitemap_view        = ( isset( $_POST['sitemap_view'] ) ) ? sanitize_text_field( $_POST['sitemap_view'] ) : '';
		$settings->exclude_posts       = ( isset( $_POST['exclude_posts'] ) ) ? apply_filters( 'sanitize_post_array', $_POST['exclude_posts'] ) : '';
		$settings->exclude_terms       = ( isset( $_POST['exclude_terms'] ) ) ? apply_filters( 'sanitize_post_array', $_POST['exclude_terms'] ) : '';
		...
		$settings->google_news_exclude_terms = ( isset( $_POST['google_news_exclude_terms'] ) ) ? apply_filters( 'sanitize_post_array', $_POST['google_news_exclude_terms'] ) : '';
		...
		$settings->exclude_broken_images   = ( isset( $_POST['exclude_broken_images'] ) ) ? sanitize_text_field( $_POST['exclude_broken_images'] ) : 0;
		...
		$settings->minimize_sitemap         = ( isset( $_POST['minimize_sitemap'] ) ) ? sanitize_text_field( $_POST['minimize_sitemap'] ) : 0;
		...
		if ( $settings->sitemap_view !== $saved_settings->sitemap_view ) {
			Cache::clear();
			flush_rewrite_rules();
		}
